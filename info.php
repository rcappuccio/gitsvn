...
BODY
   {
   background-color: #FFFFFF; color: #000000; margin: 1em; 
...
<p>
<ul>
	<li>The list of repositories you created</li>
	<li>The list of repositories created by others, for which you have been granted access (at user level)</li>
    	<li>The list of repositories created by others, for which you have been granted access (at group level)</li>
</ul>
<p>
...
<p>
<ul>
	<li>/repositories/svn/username/repositoryname</li>
	<li>/repositories/git/username/repositoryname</li>
</ul>
<p>
<p>Therefore, the addresses for checking out (SVN) or cloning (GIT) are:</p>
<p>
<ul>
	<li>http://<?php print $_SERVER['SERVER_NAME']?>/repositories/svn/username/repositoryname (for SVN)</li>
	<li>http://<?php print $_SERVER['SERVER_NAME']?>/repositories/git/username/repositoryname.git (for GIT)</li>
</ul>
<p>
...
The repository is created immediately but you have to wait a minute for the Apache2 server to restart in order to have it working.</p>
<p>
...
For SVN, the authorization can be given for directories.<br>
...
<p>
<ul>
	<li>the creator/owner of the repository</li>
	<li>the $ADMIN_GROUP group</li>
</ul>
<p>
...
The URL of the repository, to be used for checking it out, will also reflect the change.</br>
For example, if user original_owner creates a repository called my_repository, it will have this URL:</p>
<p>
<ul>
	<li>https://<?php print $_SERVER['SERVER_NAME']?>/repositories/svn/original_owner/my_repository</a></li>
</ul>
<p>
<p>After transferring it to user new_owner, it will have this URL:</p>
<p>
<ul>
	<li>https://<?php print $_SERVER['SERVER_NAME']?>/repositories/svn/new_owner/my_repository</a></li>
</ul>
<p>
